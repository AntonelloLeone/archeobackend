...
public partial class WrittenSourcesObject
{
    ...
    public virtual WrittenSource WrittenSource { get; set; } = null!;

    public virtual WrittenSourcesExtract WrittenSourcesExtract { get; set; } = null!;
}
